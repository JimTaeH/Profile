...
<p> Refer and thanks to <a href="https://github.com/rmokady/CLIP_prefix_caption">R. Mokady, CLIP_prefix_caption</a>. This model consist of 3 model that is CLIP, Mapping Network (Prefix Caption Model), and GPT-2. Process start from input image into CLIP model for extract features of image. Then using image features </p>
<div align="center">
